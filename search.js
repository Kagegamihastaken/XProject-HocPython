$(document).ready(function () {
    ...
    var items = [
        ...
        { name: "Cách tạo file Python bằng phương pháp File Explorer", link: "/course/1.4/#A", subname: "1.4 - Chương trình đầu của bạn" },
        { name: "Chạy chương trình đầu của bạn bằng Command Prompt", link: "/course/1.4/#B", subname: "1.4 - Chương trình đầu của bạn" },
        { name: "Cách tạo file Python ở trong Visual Studio Code", link: "/course/1.4/#C", subname: "1.4 - Chương trình đầu của bạn" },
        { name: "Cách chạy file Python ở trong Visual Studio Code", link: "/course/1.4/#D", subname: "1.4 - Chương trình đầu của bạn" },
        { name: "Cách tạo file Python ở trong Pycharm", link: "/course/1.4/#E", subname: "1.4 - Chương trình đầu của bạn" },
        { name: "Cách chạy file Python ở trong Pycharm", link: "/course/1.4/#F", subname: "1.4 - Chương trình đầu của bạn" },
